#!/usr/bin/env python3
"""
Validate Earth Brain OS v0.2 example files against JSON Schemas.
...
The integrated schema may reference layer schemas via local $ref paths,
...
print("[INFO] Earth Brain OS v0.2 example validation started.")
